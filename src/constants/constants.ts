...
export const SECONDARY_BUTTON = {
    "RED": "hover:bg-red-600 text-red-600",
    "BLUE": "hover:bg-blue-600 text-blue-600",
    "GRAY": "hover:bg-gray-600 text-gray-600",
    "GREEN": "hover:bg-green-600 text-green-600",
}
